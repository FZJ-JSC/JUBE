...
class TestHelloWorldExample(TestExample):

    """Class for testing the cycle example"""

    def setUp(self):
        self._path = os.path.join(TestExample.EXAMPLES_PREFIX, "hello_world")
        self._xml_file = os.path.join(self._path, "hello_world.xml")
        self._yaml_file = os.path.join(self._path, "hello_world.yaml")

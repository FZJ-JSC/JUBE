...
class TestParameterDependenciesExample(TestExample):

    """Class for testing the cycle example"""

    def setUp(self):
        self._path = os.path.join(TestExample.EXAMPLES_PREFIX, "parameter_dependencies")
        self._xml_file = os.path.join(self._path, "parameter_dependencies.xml")
        self._yaml_file = os.path.join(self._path, "parameter_dependencies.yaml")
        ...
        self._wp_paths = None
        self._stdout = ["hello 3 10", "hello 5 10", "world 1 20",

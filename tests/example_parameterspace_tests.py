...
class TestParameterspaceExample(TestExample):

    """Class for testing the cycle example"""

    def setUp(self):
        self._path = os.path.join(TestExample.EXAMPLES_PREFIX, "parameterspace")
        self._xml_file = os.path.join(self._path, "parameterspace.xml")
        self._yaml_file = os.path.join(self._path, "parameterspace.yaml")
        ...
        self._wp_paths = None
        self._stdout = [text + number for number in ["1", "2", "4"]
